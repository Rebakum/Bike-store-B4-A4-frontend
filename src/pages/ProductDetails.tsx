      ...
      <div className="overflow-hidden bg-white rounded-lg shadow-lg">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="flex flex-col justify-center p-6">
            ...
            <p className="py-2 mb-2 text-sm text-gray-500 md:text-base">
              {product.category} Bike | Model: {product.model}
            </p>
            <Button className="flex w-[120px] text-xl bg-green-500 hover:bg-green-500 cursor-default">
            ...
            {product?.inStock && (
              <div className="flex flex-col gap-4 mt-6 sm:flex-row">
                ...
                <button
                  onClick={handleOrder}
                  className="px-4 py-2 border bg-gray-900 text-white  rounded-md font-semibold hover:scale-[1.05] hover:text-white duration-300 transition"
                >
                  Order
                </button>
              </div>
